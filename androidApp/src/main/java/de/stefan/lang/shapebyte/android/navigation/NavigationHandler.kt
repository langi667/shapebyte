...
import de.stefan.lang.shapebyte.features.home.NavigationRequestQuickWorkout
...
class NavigationHandler(
    ...
    override fun handleNavigationRequest(request: NavigationRequest) {
        when (request) {
            ...
            is NavigationRequestQuickWorkout -> navHostController.navigate(navRouteBuilder.quickWorkoutRoute(request.workoutId))
