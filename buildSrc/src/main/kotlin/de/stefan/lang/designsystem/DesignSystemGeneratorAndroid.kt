...
class DesignSystemGeneratorAndroid: DesignSystemGenerating {
    ...
    private fun generateThemeAdditions(outputFile: File) {
        ...
        val fileSpec = FileSpec.builder(packageName, objectName)
            ...
            //.addImport("de.stefan.lang.coreutils.contract", "Logger")
            .addImport("de.stefan.lang.designsystem.contract", "Dimensions")
            .addImport("de.stefan.lang.designsystem.contract", "Spacings")
    ...
    private fun loggerProperty(): PropertySpec {
        return PropertySpec.builder(
            "logger",
            ClassName("de.stefan.lang.utils.logging.contract", "Logger")
        )
    ...
    private fun dimensionsProperty(): PropertySpec {
        ...
        val property = PropertySpec.builder(
            name = "dimensions",
            type = ClassName(
                packageName = "de.stefan.lang.designsystem.contract", "Dimensions")
        )
            .initializer(initializer)
            .build()
    ...
    private fun spacingsProperty(): PropertySpec {
        ...
        val property = PropertySpec.builder(
            name = "spacings",
            type = ClassName(
                packageName = "de.stefan.lang.designsystem.contract", "Spacings")
        )
            .initializer(initializer)
            .build()
